...
CREATE TABLE `user_role` (
  ...
  CONSTRAINT `user_frk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
INSERT INTO `users` VALUES (1,1,'test@test.com','test','test','test');
...
-- Dump completed on 2019-06-17  0:21:39
